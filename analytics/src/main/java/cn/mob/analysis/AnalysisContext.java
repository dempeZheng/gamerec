...
import cn.mob.analysis.store.StoreMapManager;
...
public class AnalysisContext {
    ...
    public void startAnalysis() {
        ...
        ExecutorService analysisPool = Executors.newFixedThreadPool(analysisPoolSize, Threads.makeThreadFactory("ANALYSIS"));
    ...
    public void startQueuePuller() {
        ...
        ExecutorService queuePullerPool = Executors.newFixedThreadPool(queues.size(), Threads.makeThreadFactory("QUEUE_PULLER"));
